...
function firebugFrameLoad(Firebug)
{
    ...
    Firebug.registerTracePrefix("allyEnhancer;", "DBG_ALLYENHANCER", true,
        "chrome://allyenhancer/skin/allyenhancer.css");
    ...
    var config = {id: "allyenhancer@lesjardinsdenat.com"};
    Firebug.registerExtension("allyenhancer", config);
}
...
function firebugFrameUnload(Firebug)
{
    ...
    Firebug.unregisterExtension("allyenhancer");
    Firebug.unregisterTracePrefix("allyEnhancer;");
}
